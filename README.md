...
这是一个本地可运行、面向多教师和多学生使用的 GESP C++ 练习平台原型。当前已经具备试卷练习、账号登录、客观题判分、C++ 编程题评测、练习记录、班级、作业、教师管理台和管理员用户管理。
...
教师可以在页面的“管理”中用 JSON 方式新增或编辑试卷。题目结构：
